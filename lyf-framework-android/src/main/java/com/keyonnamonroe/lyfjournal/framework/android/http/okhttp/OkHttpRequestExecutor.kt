package com.keyonnamonroe.lyfjournal.framework.android.http.okhttp
...
import com.keyonnamonroe.lyfjournal.framework.android.http.okhttp.internal.RequestCleanupSpec
import com.keyonnamonroe.lyfjournal.framework.android.http.okhttp.internal.RequestCleanupStrategy
import com.keyonnamonroe.lyfjournal.framework.android.http.okhttp.internal.RequestState
import com.keyonnamonroe.lyfjournal.framework.android.http.okhttp.request.internal.HttpException
...
import com.keyonnamonroe.lyfjournal.framework.android.http.okhttp.response.internal.HttpStatusCode
 ...
 *
 * @property client OkHttpClient Factory for calls, which can be used to send HTTP requests and
 * read their responses.
 * @property interceptor Interceptor? Observes, modifies, and potentially short-circuits requests
 * going out and the corresponding responses coming back in. Typically interceptors add, remove,
 * or transform headers on the request or response.
 * @property connectionSpec List<ConnectionSpec> Unencrypted, unauthenticated connections for
 * http: URLs.
 * @property requestCleanupStrategy RequestCleanupSpec A resource cleanup/release strategy for
 * HTTP requests.
 * @constructor
 */
open class OkHttpRequestExecutor(
     ...
     *
     * <p>Configures client based on interceptor and connection spec properties<p/>
     */
    ...
    private fun handleSuccessfulResponse(
        ...
        callback?.onSuccess(
            responseItem = if (stringBody.isEmpty()) {
