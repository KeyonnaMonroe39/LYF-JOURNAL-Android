...
interface ResponseCallback<T : EmptyStateInfo> {
     ...
     *
     * @param result A successful variant of the [Response].
     */
    fun onSuccess(result: Response.Success<T>)

    /**
     * Represents that a request failed.
     *
     * @param result A failed variant of the [Response].
     */
    fun onFailure(result: Response.Failure<T>)
}
