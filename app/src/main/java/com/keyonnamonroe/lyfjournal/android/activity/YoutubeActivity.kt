...
import com.keyonnamonroe.lyfjournal.android.databinding.ActivityYoutubeBinding
...
class YoutubeActivity : YouTubeBaseActivity(), YouTubePlayer.OnInitializedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityYoutubeBinding.inflate(layoutInflater).apply {
            setContentView(root)
        }

        binding.youtubePlayerActivity.initialize("AIzaSyBrSpSxl1yF8PABIfpOCAWpXDq__pHttVE", this)
    }
